...
The package  [parsnip](https://parsnip.tidymodels.org/) is the one handling the transition from model to model. IN this process it is easy to swift between models.
