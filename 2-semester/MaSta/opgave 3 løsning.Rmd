...
```{r}
data <- read.csv("Documents/Projects/aarhus-dv/2-semester/MaSta/MatStat-R/data/FlightDelays.csv")
```
...
```{r}
data <- read.csv("../Documents/Projects/aarhus-dv/2-semester/MaSta/MatStat-R/data/IceCream.csv")
```
